...
(function () {
    var loadPackage = function (metadata) {
        ...
        var PACKAGE_NAME = "blazeface-simd.data";
        var REMOTE_PACKAGE_BASE = "blazeface-simd.data";
        if (
        ...
        function runWithFS() {
            ...
            function processPackageData(arrayBuffer) {
                ...
                Module["removeRunDependency"]("datafile_blazeface-simd.data");
            }
            Module["addRunDependency"]("datafile_blazeface-simd.data");
    ...
    loadPackage({
        files: [
            { filename: "/blaceface.bin", start: 0, end: 692296, audio: 0 },
            {
                filename: "/blaceface.param",
                start: 692296,
                end: 704503,
                audio: 0,
            },
        ],
        remote_package_size: 704503,
        package_uuid: "11fe56ad-84b0-43b6-80f6-0095f776856e",
    });
})();
var moduleOverrides = {};
var key;
...
var wasmBinaryFile = "blazeface-simd.wasm";
...
var _blazeface_ncnn = (Module["_blazeface_ncnn"] = function () {
    return (_blazeface_ncnn = Module["_blazeface_ncnn"] =
        Module["asm"]["blazeface_ncnn"]).apply(null, arguments);
});
